# For continuous outcome and uncorrealted genotypes, simulate the power combined and seperated modles using SKAT, and also calculate the theoretical power using  Lee's method
...
result<-powerC_mean(n = 2000, k = 50, p = 0.01, runs = 100, list1 = beta1list[[index]], list2 = beta2list[[index]])
