#' powerC_mean.R
#' For continuous outcome and uncorrealted genotypes, calculate simulated power for combined and seperated modles using SKAT, and also calculate the theoretical power using  Lee's method
...
#' # Should return powerE=0.988,powerSeparated=1,powerCombined=0.2

powerC_mean<-function(k,n,alpha,p,runs,list1,list2){
